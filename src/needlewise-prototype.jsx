...
// ─── LNS SHOPS ────────────────────────────────────────────────────────────────
const SHOPS = [
    {name:'The Needlepoint Place, Inc.',city:'Trussville',state:'AL',url:'',hours:'',phone:'',ig:''},
    {name:'Simply Needlepoint',city:'Alamo',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'JEBBA Needlepoint Designs',city:'Corona del Mar',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Newport Needlepoint',city:'Costa Mesa',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Janna\'s Needle Art',city:'Fresno',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Needlepoint of La Jolla',city:'La Jolla',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Stitched Up Needleworks',city:'Morgan Hill',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Willy\'s Needleworks',city:'Orange',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'The Artful Needle',city:'Petaluma',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Golden Gate Needlepoint',city:'San Francisco',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'A Stitch in Time (San Marino)',city:'San Marino',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Queen Anne Stitches',city:'Santa Clarita',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'Exclamation Point!',city:'Saratoga',state:'CA',url:'',hours:'',phone:'',ig:''},
    {name:'A Stitch in Time (Bethel)',city:'Bethel',state:'CT',url:'',hours:'',phone:'',ig:''},
    {name:'The Needlepoint Shop of Guilford',city:'Branford',state:'CT',url:'',hours:'',phone:'',ig:''},
    {name:'In Stitches LLC',city:'Greenwich',state:'CT',url:'',hours:'',phone:'',ig:''},
    {name:'The Needlepoint Nook of Mystic',city:'Mystic',state:'CT',url:'',hours:'',phone:'',ig:''},
    {name:'Golden Needle',city:'New Milford',state:'CT',url:'',hours:'',phone:'',ig:''},
    {name:'Two Morrows',city:'New Castle',state:'DE',url:'',hours:'',phone:'',ig:''},
    {name:'The Whimsical Needle',city:'Wilmington',state:'DE',url:'',hours:'',phone:'',ig:''},
    {name:'Eye of the Needle Guild',city:'Sarasota',state:'FL',url:'',hours:'',phone:'',ig:''},
    {name:'Seaside Needlepoint',city:'Vero Beach',state:'FL',url:'',hours:'',phone:'',ig:''},
    {name:'Cottage Finishers',city:'Rome',state:'GA',url:'',hours:'',phone:'',ig:''},
    {name:'The Stitchery of St. Simons',city:'St. Simons Island',state:'GA',url:'',hours:'',phone:'',ig:''},
    {name:'Fiddlesticks Too, Inc.',city:'Honolulu',state:'HI',url:'',hours:'',phone:'',ig:''},
    {name:'Fiberworks Needlework Shop',city:'Waverly',state:'IA',url:'',hours:'',phone:'',ig:''},
    {name:'Isabel\'s Needlepoint',city:'Ketchum',state:'ID',url:'',hours:'',phone:'',ig:''},
    {name:'Sun Valley Needle Arts',city:'Ketchum',state:'ID',url:'',hours:'',phone:'',ig:''},
    {name:'The Needle\'s Excellency',city:'Evanston',state:'IL',url:'',hours:'',phone:'',ig:''},
    {name:'Village Needleworks Ltd.',city:'Westmont',state:'IL',url:'',hours:'',phone:'',ig:''},
    {name:'Needle Nest (Goshen)',city:'Goshen',state:'IN',url:'',hours:'',phone:'',ig:''},
    {name:'Needle Fiber Arts, Inc.',city:'Prairie Village',state:'KS',url:'',hours:'',phone:'',ig:''},
    {name:'Elegant Traditions Ltd.',city:'Bowling Green',state:'KY',url:'',hours:'',phone:'',ig:''},
    {name:'Needle Arts Studio',city:'New Orleans',state:'LA',url:'',hours:'',phone:'',ig:''},
    {name:'The World of Stitches',city:'Littleton',state:'MA',url:'',hours:'',phone:'',ig:''},
    {name:'Erica Wilson Needleworks',city:'Nantucket',state:'MA',url:'',hours:'',phone:'',ig:''},
    {name:'Knit and Stitch = Bliss',city:'Bethesda',state:'MD',url:'',hours:'',phone:'',ig:''},
    {name:'Bedecked and Beadazzled',city:'Lutherville',state:'MD',url:'',hours:'',phone:'',ig:''},
    {name:'From Start to Finish',city:'Potomac',state:'MD',url:'',hours:'',phone:'',ig:''},
    {name:'Needlepoint For You',city:'Troy',state:'MI',url:'',hours:'',phone:'',ig:''},
    {name:'The Stitch Niche',city:'Pass Christian',state:'MS',url:'',hours:'',phone:'',ig:''},
    {name:'Front Street Company',city:'Dillsboro',state:'NC',url:'',hours:'',phone:'',ig:''},
    {name:'Stitch Point',city:'Greensboro',state:'NC',url:'',hours:'',phone:'',ig:''},
    {name:'Moore Than Needlepoint',city:'Pinehurst',state:'NC',url:'',hours:'',phone:'',ig:''},
    {name:'Adornment Needlepoint Boutique',city:'Winston-Salem',state:'NC',url:'',hours:'',phone:'',ig:''},
    {name:'Needlepoint Epiphany',city:'Amherst',state:'NH',url:'',hours:'',phone:'',ig:''},
    {name:'Contoocook Needlework Gallery',city:'Contoocook',state:'NH',url:'',hours:'',phone:'',ig:''},
    {name:'Hunters',city:'Meredith',state:'NH',url:'',hours:'',phone:'',ig:''},
    {name:'Mrs. Stitches',city:'Mendham',state:'NJ',url:'',hours:'',phone:'',ig:''},
    {name:'Twisted Stitches Needlepoint',city:'Albuquerque',state:'NM',url:'',hours:'',phone:'',ig:''},
    {name:'Golden Thread Needlearts',city:'East Rochester',state:'NY',url:'',hours:'',phone:'',ig:''},
    {name:'Cincinnati Needlepoint',city:'Cincinnati',state:'OH',url:'',hours:'',phone:'',ig:''},
    {name:'Stitches of Tulsa',city:'Tulsa',state:'OK',url:'',hours:'',phone:'',ig:''},
    {name:'Needlepoint Plus',city:'Beaverton',state:'OR',url:'',hours:'',phone:'',ig:''},
    {name:'Buzy Lizzy',city:'Chadds Ford',state:'PA',url:'',hours:'',phone:'',ig:''},
    {name:'Stitches Unlimited',city:'Lancaster',state:'PA',url:'',hours:'',phone:'',ig:''},
    {name:'Barbara Sue Brody Needlework',city:'Aiken',state:'SC',url:'',hours:'',phone:'',ig:''},
    {name:'Joy of Needlepoint',city:'Brentwood',state:'TN',url:'',hours:'',phone:'',ig:''},
    {name:'Needle Nest (Columbia)',city:'Columbia',state:'TN',url:'',hours:'',phone:'',ig:''},
    {name:'Stitches (Knoxville)',city:'Knoxville',state:'TN',url:'',hours:'',phone:'',ig:''},
    {name:'Needlepoint & Other Things',city:'Salt Lake City',state:'UT',url:'',hours:'',phone:'',ig:''},
    {name:'The Needlewoman East',city:'Falls Church',state:'VA',url:'',hours:'',phone:'',ig:''},
    {name:'Village Needlepoint of Irvington',city:'Irvington',state:'VA',url:'',hours:'',phone:'',ig:''},
    {name:'Village Stitchery',city:'Newport News',state:'VA',url:'',hours:'',phone:'',ig:''},
    {name:'Point on Piccadilly',city:'Roanoke',state:'VA',url:'',hours:'',phone:'',ig:''},
    {name:'Battenkill Stitchery',city:'Arlington',state:'VT',url:'',hours:'',phone:'',ig:''},
    {name:'Charleston Needlepoint',city:'Charleston',state:'WV',url:'',hours:'',phone:'',ig:''},
    {name:'Creative Needle Arts',city:'Gulf Shores',state:'AL',url:'https://creativeneedlearts.com',hours:'Tues, Weds, Fri, Sat 10am-4pm, Thurs 1pm-7pm',phone:'(251) 223-6146',ig:'https://www.instagram.com/creativeneedlearts/?hl=en',lat:30.246,lng:-87.7},
    {name:'Grits Needlepoint',city:'Homewood',state:'AL',url:'https://www.gritsneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Needleworks of Alabama / Grits Needlepoint',city:'Homewood',state:'AL',url:'https://www.gritsneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'The Needle Bug',city:'Montgomery',state:'AL',url:'https://www.theneedlebug.com',hours:'Tues-Fri 10am-4pm',phone:'(334) 270-0064',ig:'https://www.instagram.com/theneedlebug/',lat:32.361,lng:-86.279},
    {name:'Magic City Needlepoint',city:'Vestavia Hills',state:'AL',url:'https://www.magiccityneedlepoint.com',hours:'Tues, Thurs, Fri 10am-4pm, Wed 10am-6pm, Sat 10am-3pm',phone:'(205) 721-7277',ig:'',lat:33.445,lng:-86.791},
    {name:'The Yarn Mart',city:'Little Rock',state:'AR',url:'https://www.yarnmart.com',hours:'',phone:'',ig:''},
    {name:'Family Arts Needlework Shop',city:'Phoenix',state:'AZ',url:'https://www.familyartsaz.com',hours:'',phone:'',ig:''},
    {name:'Be Stitched Needlepoint',city:'Scottsdale',state:'AZ',url:'https://www.bestitchedneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Old Town Needlework',city:'Scottsdale',state:'AZ',url:'https://www.oldtownneedlework.com',hours:'',phone:'',ig:''},
    {name:'Quail Run Needlework',city:'Scottsdale',state:'AZ',url:'https://www.quailrunneedlework.com',hours:'Mon-Fri 10am-4pm, Sat 10am-2pm',phone:'480-551-1423',ig:'',lat:33.494,lng:-111.926},
    {name:'The Busy Needle',city:'Tucson',state:'AZ',url:'https://www.busyneedle.com',hours:'',phone:'',ig:'',lat:32.221,lng:-110.969},
    {name:'The West, Inc.',city:'Tucson',state:'AZ',url:'https://www.thewestinc.com',hours:'Mon-Sat 10am-4pm',phone:'(520) 299-1044',ig:'',lat:32.221,lng:-110.969},
    {name:'Needle in a Haystack (Alameda)',city:'Alameda',state:'CA',url:'https://www.needlestack.com',hours:'',phone:'',ig:''},
    {name:'Auburn Needleworks',city:'Auburn',state:'CA',url:'https://www.auburnneedleworks.com',hours:'',phone:'',ig:''},
    {name:'Flying Fuzzies',city:'Cambria',state:'CA',url:'https://www.flyingfuzzies.com',hours:'',phone:'',ig:''},
    {name:'Garden Gate Needlepoint',city:'Covina',state:'CA',url:'https://www.gardengateneedlepoint.com',hours:'g New Canvases This Month! by Officially Needlepoint Shop Snoopy 2025 Trunk Show Schedule Join us at our trunk show, online or in-person! 2025 Schedule Amazing Needlepoint Finishing Natural pumpkin stem... silk leaves and autumn embellishments! See finishing examples No 1 in Customer Service Come on by or give us a call! We would love to help you with your next needlepoint masterpiece! (626) 966-4141 1 / of 4 Shop Our Needlepoint Collections Needlepoint Clearance Sale Needlepoint Clearance Sale Stockings Stockings Pillows Pillows Ornaments Ornaments Eyeglasses Case Eyeglasses Case Beach Beach View all Shop With Us Free Shipping to All 48 Contiguous states Safe Payments Guaranteed Premium Needlepoint Canvases Our Newest Additions Snoopy in Puffer Coat Sale Snoopy in Puffer Coat Regular price $92.00 USD Regular price $102.00 USD Sale price $92.00 USD Unit price / per Sale Woodstock in Stocking Cap Sale Woodstock in Stocking Cap Regular price $92.00 USD Regular price $102.00 USD Sale price $92.00 USD Unit price / per Sale Joe Cool Joe Cool Regular price $102.00 USD Regular price Sale price $102.00 USD Unit price / per Snoopy in Lit Doghouse Sale Snoopy in Lit Doghouse Regular price $150.00 USD Regular price $164.00 USD Sale price $150.00 USD Unit price / per Sale Woodstock in Puffer Coat Sale Woodstock in Puffer Coat Regular price $92.00 USD Regular price $102.00 USD Sale price $92.00 USD Unit price / per Sale Snoopy with Stocking Cap Sale Snoopy with Stocking Cap Regular price $92.00 USD Regular price $102.00 USD Sale price $92.00 USD Unit price / per Sale Pickleball Snoopy Pickleball Snoopy Regular price $101.00 USD Regular price Sale price $101.00 USD Unit price / per Snoopy Joe Cool Sale Snoopy Joe Cool Regular price $92.00 USD Regular price $105.00 USD Sale price $92.00 USD Unit price / per Sale Woodstock with Flag Sale Woodstock with Flag Regular price $83.00 USD Regular price $102.00 USD Sale price $83.00 USD Unit price / per Sale Snoopy with Flag Sale Snoopy with Flag Regular price $92.00 USD Regular price $102.00 USD Sale price $92.00 USD Unit price / per Sale Woodstock Graduation Dance Sale Woodstock Graduation Dance Regular price $92.00 USD Regular price $102.00 USD Sale price $92.00 USD Unit price / per Sale Snoopy Graduation Dance Sale Snoopy Graduation Dance Regular price $94.00 USD Regular price $102.00 USD Sale price $94.00 USD Unit price / per Sale View all Our Happy Customers Amy F. Review from Yelp ★★★★★ "Wow, just wow! I read the reviews to see if it was worth the drive since I\'m only in this area for a couple of hours on business. Everyone always mentions something nice about Carol the owner ---- and they ARE SPOT ON! From the moment I walked in I felt like I was someone special. So many fibers to..." Read More David G. Review from Yelp ★★★★★ "I am not a crafty nor a needlepoint kind of guy. My experience with Garden Gate is solely with the owner Carole R. Carole is a member of BSF International, and has made her shop available for other members to acquire the printed materials needed for the year-long study, AND at an extremely fair price point. It was a ..." Read More Trixi C. Review from Yelp ★★★★★ "It is too bad there is no picture of the shop or the owner. This has been my home away from home! Carol, the owner, is a delight and loved by all! Her teachers are fabulous and so is her finisher. I have been driving to this place for classes from Mission Viejo for years. They have lots of \'stuff\' and Carol is very conscious of ..." Read More Average Rating: 4.9 out of 5 (based on 14 reviews) Sourced From About Us Garden Gate Needlepoint is your trusted source for needlepoint canvases both online and in-store. Since 1976 , we’ve been providing high-quality hand-painted canvases, fibers, and needlepoint accessories to needlepoint enthusiasts. We have informative in-person classes throughout the week. Your finished canvases can be framed to add to the beauty of your home, or if you prefer, finished by JRG Designs, our in-house finisher, who creates masterpieces exclusively for Garden Gate. We proudly carry quality supplies, including beautiful hand-painted canvasses, a wonderful selection of books and other supplies and, of course, an outstanding array of fibers. Garden Gate Needlepoint has been the cornerstone of all things needlepoint since 49 years and counting . Shop Needlepoint Canvases JOIN OUR MONTHLY EMAIL BLAST! Sign up with your email address to receive news and updates. Email Ring us up! We\'re THRILLED to address your queries or aid in your canvas hunt! (626) 966-4141 Join Us at Garden Gate Sun & Mon - Closed Tue thru Fri - 10-4 Saturday - 10-2 236 N. Citrus Ave Covin',phone:'',ig:'',lat:34.09,lng:-117.89},
    {name:'Needlepoints, Ltd.',city:'Garden Grove',state:'CA',url:'https://www.needlepointsltd.com',hours:'',phone:'',ig:''},
    {name:'Needle Nook of La Jolla',city:'La Jolla',state:'CA',url:'https://www.needlenookoflajolla.com',hours:'',phone:'',ig:''},
    {name:'Needlepoints West',city:'Los Angeles',state:'CA',url:'https://www.needlepointswest.com',hours:'',phone:'',ig:''},
    {name:'Old World Designs',city:'Menlo Park',state:'CA',url:'https://www.oldworlddesigns.com',hours:'Mon-Sat 10am -4pm',phone:'',ig:'',lat:37.453,lng:-122.182},
    {name:'Needle in a Haystack (Montrose)',city:'Montrose',state:'CA',url:'https://www.needleinahaystackmontrose.com',hours:'',phone:'',ig:''},
    {name:'2 The Point',city:'Pleasanton',state:'CA',url:'https://www.2needlepoint.com',hours:'By Appointment Only',phone:'(925) 461-8664',ig:'https://instagram.com/terry.castillo',lat:37.662,lng:-121.875},
    {name:'The Needlepointer (Sacramento)',city:'Sacramento',state:'CA',url:'https://www.theneedlepointer.com',hours:'ip within about one month. Shop now Explore our abundant threads Immerse yourself in a world of endless color and texture. From silky cottons to rich wools, each thread is thoughtfully crafted to inspire creativity and elevate every stitch. Add Threads Stitch-to-finish Stitch-to-Finish is our signature innovation that combines stitching and finishing in one seamless experience. Each kit includes coordinated materials, guided instructions, and our patent-pending self-finishing system, allowing you to create a beautifully finished piece from the first stitch to the final detail—no professional finishing required. Shop now ACCESSORIES Essential tools for effortless needlepoint — laying tools, stretcher bars, needles, nails, and scissors designed for precision, ease, and finesse. Shop now Customer Support Customer Support Contact Us Reward Program Shipping & Order Policy Programs & Service Programs & Service Monthly Trunk Show Finishing Service Subscription Box Our Newsletter - Get Updates, Offers and Invites. Email Showroom: 1944 Terracina Dr., Sacramento, CA 95834 Hours: 10am - 4pm Mon-Fri Stay Connected © 2026 The Needlepointer Priva',phone:'',ig:'',lat:38.581,lng:-121.494},
    {name:'Needlepoint, Inc.',city:'San Francisco',state:'CA',url:'https://www.needlepointinc.com',hours:'lternative Icon New Hours In-Store New Hours In-Store Arrow Thin Left Icon Arrow Thin Right Icon One of a kind Canvases Hand-painted canvases only available at Needle',phone:'',ig:'',lat:37.774,lng:-122.419},
    {name:'Luv 2 Stitch',city:'San Mateo',state:'CA',url:'https://luv2stitch.com',hours:'',phone:'',ig:''},
    {name:'Come to the Point',city:'San Rafael',state:'CA',url:'https://www.cometothepoint.com',hours:'',phone:'',ig:''},
    {name:'Aristeia Needlepoint',city:'Santa Monica',state:'CA',url:'https://www.aristeianeedlepoint.com',hours:'Mon-Fri 10am-4pm, Sat 10am-5pm',phone:'(310)-260-6330',ig:'',lat:34.019,lng:-118.491},
    {name:'NeedleHearts',city:'Tarzana',state:'CA',url:'https://www.needlehearts.com',hours:'ct to change Hours: Monday 10:00 a.m. to 2:00 p.m. Tuesday 10:00 p.m. to 2:00 p.m. Wednesday 10:00 a.m. to 3:30 p.m. Thursday 10:00 a.m. to 1:00 p.m. Friday 10:00 a.m. to 1:00 p.m. Saturday 10:00 a.m. to 2:00 p.m. Closed Sundays Close × OK Navigate Classes Designers Threads Shipp',phone:'',ig:'',lat:34.168,lng:-118.549},
    {name:'Eva\'s Needlework',city:'Thousand Oaks',state:'CA',url:'https://www.evasneedlework.com',hours:'',phone:'',ig:''},
    {name:'Sit \'N Stitch',city:'Toluca Lake',state:'CA',url:'https://www.sitnstitch.com',hours:'',phone:'',ig:''},
    {name:'Concepts in Yarn & Needlepoint',city:'Torrance',state:'CA',url:'https://www.conceptsinyarn.com',hours:'',phone:'',ig:''},
    {name:'A Stitching Shop',city:'Denver',state:'CO',url:'https://www.stitchingshop.com',hours:'Mon–Sat 10am-5pm',phone:'(303) 727-8500',ig:'https://www.instagram.com/astitchingshop/',lat:39.739,lng:-104.984},
    {name:'Downing Street Needlepoint',city:'Denver',state:'CO',url:'https://downingstreetneedlepoint.com',hours:'t Close search Home Hours & Class Schedule Subscribe To Our Monthly Newsletter Stay up to date about our trunk shows, stitch of the month, and exclusive club updates.',phone:'',ig:'',lat:39.739,lng:-104.984},
    {name:'Diversions Needlepoint',city:'Englewood',state:'CO',url:'https://www.diversionsneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'House of Needlepoint',city:'Darien',state:'CT',url:'https://www.houseofneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'The Village Ewe',city:'Old Greenwich',state:'CT',url:'https://www.thevillageewe.com',hours:'',phone:'',ig:'',lat:41.025,lng:-73.568},
    {name:'Needlepoint, Needlepoint & More Needlepoint',city:'Westport',state:'CT',url:'https://www.tnsct.com',hours:'',phone:'',ig:''},
    {name:'Thistle Needleworks',city:'Wethersfield',state:'CT',url:'https://www.thistleneedleworks.com',hours:'Tues-Fri 9:30am-5:30pm, Sat 9:30am-4pm',phone:'860-257-2718',ig:'',lat:41.714,lng:-72.651},
    {name:'The Enriched Stitch',city:'Wilton',state:'CT',url:'https://www.enrichedstitch.com',hours:'online at least 24 hours in advance and select which day you plan to attend Available January Dates 1/14, 1/16, 1/28, 1/30 Content1 Whether you\'re an avid needlepoin',phone:'',ig:'',lat:41.195,lng:-73.437},
    {name:'The Point of It All',city:'Washington',state:'DC',url:'https://www.thepointofitallonline.com',hours:'Tues-Sat 10am-4pm',phone:'202-966-9898',ig:'',lat:38.907,lng:-77.036},
    {name:'Stitch-Stash',city:'Rehoboth Beach',state:'DE',url:'https://www.stitch-stash.com',hours:'Tues-Sat 11am - 4pm',phone:'(302) 569-0063',ig:'https://www.instagram.com/stitchstashneedlepoint/',lat:38.72,lng:-75.075},
    {name:'The Jolly Needlewoman',city:'Wilmington',state:'DE',url:'https://www.jollyneedlewoman.com',hours:'',phone:'',ig:''},
    {name:'Needle Orts',city:'Altamonte Springs',state:'FL',url:'https://www.needleorts.com',hours:'',phone:'',ig:''},
    {name:'The Flying Needles',city:'Belleair Bluffs',state:'FL',url:'https://www.theflyingneedles.com',hours:'WEDNESDAY - SATURDAY 10AM TO 4PM SHOP OUR MARCH TRUNK SHOW- G BANKS NEEDLEPOINT - 20%',phone:'',ig:''},
    {name:'Grande Stitches',city:'Boca Grande',state:'FL',url:'https://grandestitches.com',hours:'you visit us! Store Hours: Monday, Thursday – Saturday 10:00 a.m. – 2:00 p.m. Grande Stitches is also open by appointment.   Please call or email to schedule a time co',phone:'',ig:''},
    {name:'Radish Roots Needlepoint',city:'Bunnell',state:'FL',url:'https://radishrootsneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Stitches by the Sea',city:'Delray Beach',state:'FL',url:'https://stitchesbythesea.us',hours:'Tues 10am–6pm, Weds-Sat 10am – 4pm',phone:'561-865-5775',ig:'@StitchesbytheSea'},
    {name:'Bristly Thistle',city:'Fernandina Beach',state:'FL',url:'https://www.bristlythistle.com',hours:'',phone:'',ig:''},
    {name:'A Stitch in Time (Jacksonville)',city:'Jacksonville',state:'FL',url:'https://www.astitchintime.com',hours:'',phone:'',ig:''},
    {name:'Needlepoint Alley',city:'Lake Park',state:'FL',url:'https://www.needlepointalley.com',hours:'',phone:'',ig:''},
    {name:'Absolutely Needlepoint (Miami)',city:'Miami',state:'FL',url:'https://www.absolutelyneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Needlepoint in Paradise',city:'Naples',state:'FL',url:'https://www.needlepointinparadise.com',hours:'',phone:'',ig:''},
    {name:'The Black Sheep',city:'Orlando',state:'FL',url:'https://www.theblacksheepshop.com',hours:'Our store hours are 10 a.m. - 4 p.m. Monday - Friday and 10 a.m. - 2 p.m. on Saturday Call us at 407-894-0444 Email us at hello@theblacksheepshop.com',phone:'',ig:''},
    {name:'Needlepoint Studio of Sarasota',city:'Sarasota',state:'FL',url:'https://www.needlepointstudio.com',hours:'Name Email Address Message Submit',phone:'',ig:'',lat:27.336,lng:-82.531},
    {name:'Morgan Julia Designs (St. Pete Studio)',city:'St. Petersburg',state:'FL',url:'https://morganjuliadesigns.com',hours:'',phone:'',ig:''},
    {name:'Needlepoint Land',city:'Stuart',state:'FL',url:'https://www.needlepointland.com',hours:'',phone:'',ig:''},
    {name:'Knot the Point',city:'Tampa',state:'FL',url:'https://www.knotthepoint.com',hours:'',phone:'',ig:''},
    {name:'Needlepoint Ivy',city:'Venice',state:'FL',url:'https://www.needlepointivy.com',hours:'',phone:'',ig:''},
    {name:'Needle Nicely',city:'Vero Beach',state:'FL',url:'https://www.needlenicely.com',hours:'',phone:'',ig:''},
    {name:'Novella Needlepoint',city:'Winter Park',state:'FL',url:'https://novellaneedlepoint.com',hours:'',phone:'',ig:'',lat:28.6,lng:-81.339},
    {name:'Atlanta Needlepoint & Monogramming',city:'Atlanta',state:'GA',url:'https://www.atlantaneedlepointandmonogramming.com',hours:'',phone:'',ig:''},
    {name:'In Stitches (Atlanta)',city:'Atlanta',state:'GA',url:'https://www.institchesatlanta.com',hours:'',phone:'',ig:''},
    {name:'Labors of Love Needlepoint',city:'Atlanta',state:'GA',url:'https://laborsofloveneedlepoint.shop',hours:'Enter email here Subscribe to receive exclusive deals, news, and events.',phone:'',ig:'',lat:33.749,lng:-84.388},
    {name:'Cast-On Cottage',city:'Roswell',state:'GA',url:'https://www.castoncottage.com',hours:'',phone:'',ig:''},
    {name:'The Nimble Needle (Sandy Springs)',city:'Sandy Springs',state:'GA',url:'https://www.atlantanimbleneedle.com',hours:'',phone:'',ig:''},
    {name:'Savannah Needlepoint',city:'Savannah',state:'GA',url:'https://www.savannahneedlepoint.com',hours:'ook Instagram Store Hours Sunday: Closed Monday: Closed Tuesday: 10-5 Wednesday: 10-6 Thursday: 10-6 Friday: 10-5 Saturday: 10-4 Subscribe to our emails Email Faceboo',phone:'',ig:'',lat:32.083,lng:-81.1},
    {name:'Needlepoint, Etc.',city:'Honolulu',state:'HI',url:'https://www.needlepointhi.com',hours:'',phone:'',ig:''},
    {name:'Needlepoint Beach',city:'Des Moines',state:'IA',url:'https://www.needlepointbeach.com',hours:'',phone:'',ig:''},
    {name:'Maydel',city:'Chicago',state:'IL',url:'https://maydel.com',hours:'open from 11am–4pm Thursday, Fridays, and Saturdays, and by appointment from 10am–4pm Mondays, Tuesdays, and Wednesdays. We’re closed on Sund',phone:'',ig:'',lat:41.878,lng:-87.63},
    {name:'Third Coast Stitches',city:'Chicago',state:'IL',url:'https://thirdcoaststitches.com',hours:'Tues, Weds, Fri 12pm-5pm, Thurs 2pm-8pm, Sat 11am-5pm, Sun 11am-4pm',phone:'312-285-2221',ig:'https://www.instagram.com/thirdcoaststitches/',lat:41.878,lng:-87.63},
    {name:'Designers Desk',city:'Geneva',state:'IL',url:'https://www.designersdeskusa.com',hours:'',phone:'',ig:''},
    {name:'The Forest Needle',city:'Lake Forest',state:'IL',url:'https://www.forestneedle.com',hours:'Tues-Fri 11am-5pm, Sat 11am-3pm',phone:'847-235-2407',ig:'https://www.instagram.com/theforestneedle/',lat:42.259,lng:-87.84},
    {name:'Stitchers Garden',city:'Naperville',state:'IL',url:'https://www.stitchersgardenil.com',hours:'',phone:'',ig:''},
    {name:'Emily\'s Stitchery / North Shore Needleworks',city:'Northbrook',state:'IL',url:'https://www.emilysstitchery.com',hours:'Cart Add to Cart Lemon Blues Tea Regular price $280.88 2026 Classes Sign Up Today.  Email us to be put on a waiting list. 2026 Classes Add to wishlist Quick view Add to Cart Add to Cart Beginner Needlepoint - 4/12/2026 Regular price $75.00 Add to wishlist Quick view Add to Cart Add to Cart Fabulous Fanny Flamingo Kit Regular price $600.00 Sold out Add to wishlist Quick view Beginner Needlepoint - 3/8/2026 Regular price $75.00 Sold out Add to wishlist Quick view Beginner Needlepoint - 2/8/2026 Regular price $75.00 Add to wishlist Quick view Add to Cart Add to Cart Flower Party w/ Audra Deposit May 2026 Regular price $250.00 Follow us Check out Emily\'s Exclusives Stitch Guides Clubs Canvases Sign up now & get 10% off Subscribe to our newsletter to hear the latest about classes, trunk shows, new products, and sales Subscribe Up your stitching game with national experts We offer project-based and embellishment classes at least once a month. Flower Party with Audra! Join the Class Fabulous Fanny Flamingo with Kelly Clark Join the Class Stitch Lab Join the class Our Classroom is open! Local teachers are in the shop four days a week. Weekly schedule: Monday: Embellishment with Linda Corirossi 1:00-3:00 pm $35 Tuesday: Open stitch with Chris McCoy 1:00-3:00 pm $25',phone:'',ig:''},
    {name:'The Canvasback',city:'Northfield',state:'IL',url:'https://www.canvasback-needlepoint.com',hours:'',phone:'',ig:''},
    {name:'The Classic Stitch',city:'Winnetka',state:'IL',url:'https://www.theclassicstitch.com',hours:'iffin - 20% off all month Beginner Classes: Saturday, March 14 10:00-noon Embellishment Classes: Wednesdays 1:00 - 3:00 p.m. Saturday, March 7 10:30 - 12:30 Sip & Stitch Wednesday, March 18 6-8pm Please join us! Call to sign up! 847-881-2930 Beginner Clas',phone:'',ig:'',lat:42.107,lng:-87.736},
    {name:'Stitches from the Heart',city:'Evansville',state:'IN',url:'https://www.stitches-heart.com',hours:'',phone:'',ig:''},
    {name:'Red Rooster Stitchery',city:'Newburgh',state:'IN',url:'https://www.redroosterstitchery.com',hours:'',phone:'',ig:''},
    {name:'Persnickety Stitchers',city:'Zionsville',state:'IN',url:'https://www.persnicketystitchers.com',hours:'Tues-Wed, Fri 10am-5pm, Thurs 2pm-8pm, Sat 10am-4pm',phone:'317-873-5010',ig:''},
    {name:'The Studio Knitting & Needlepoint',city:'Overland Park',state:'KS',url:'https://www.thestudiokc.com',hours:'Mon-Sat 11am-3pm',phone:'816-531-4466',ig:''},
    {name:'Two the Point Needlearts',city:'Overland Park',state:'KS',url:'https://www.twothepointneedlearts.com',hours:'',phone:'',ig:''},
    {name:'M\'s Canvashouse',city:'Lexington',state:'KY',url:'https://www.mscanvashouse.com',hours:'',phone:'',ig:''},
    {name:'Stitch Therapy Needleworks',city:'Lexington',state:'KY',url:'https://www.stitchtherapyneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Stitching Therapy Needlepoint',city:'Lexington',state:'KY',url:'https://www.stitchtherapyneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Beth\'s Needlepoint Nook / Stitchen Time',city:'Louisville',state:'KY',url:'https://www.bethsneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Stitch - A Needlepoint Shop',city:'Louisville',state:'KY',url:'https://www.stitchneedlepointshop.com',hours:'',phone:'',ig:'',lat:38.252,lng:-85.758},
    {name:'Stitch – A Needlepoint Shop',city:'Louisville',state:'KY',url:'https://www.stitchneedlepointshop.com',hours:'',phone:'',ig:'',lat:38.252,lng:-85.758},
    {name:'Needle Nest (Shelbyville)',city:'Shelbyville',state:'KY',url:'https://www.needlenestky.com',hours:'',phone:'',ig:''},
    {name:'The Elegant Needle',city:'Baton Rouge',state:'LA',url:'https://www.theelegantneedle.com',hours:'Needlepoint HOURS: Wed 10-6  |  Thu-Fri 10-4  |  Sat 11-3 Notice: in instances of inclement weather, when state offices are closed we will be as well. (225) 925-8920 phone (225) 925-8921 fax',phone:'',ig:'',lat:30.458,lng:-91.14},
    {name:'Stitch and Frame of Acadiana',city:'Broussard',state:'LA',url:'https://stitchandframeacadiana.com',hours:'',phone:'',ig:''},
    {name:'The Quarter Stitch',city:'New Orleans',state:'LA',url:'https://www.quarterstitch.com',hours:'Mon-Sun 10am-6pm',phone:'',ig:'',lat:29.951,lng:-90.072},
    {name:'Hanging by a Thread',city:'Shreveport',state:'LA',url:'https://www.hangingbyathreadshreveport.com',hours:'',phone:'',ig:''},
    {name:'Stitch Boutique of Boston',city:'Boston',state:'MA',url:'https://www.stitchboutiqueofboston.com',hours:'Mon-Tues 11am-4pm, Weds 11am-7:30pm, Thurs-Sat 11am-4pm',phone:'617-236-4633',ig:'',lat:42.36,lng:-71.059},
    {name:'Hingham Square Needlepoint',city:'Hingham',state:'MA',url:'https://www.hinghamsquareneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Osterville Needlepoint Shop',city:'Marstons Mills',state:'MA',url:'https://www.ostervilleneedlepointshop.com',hours:'',phone:'',ig:''},
    {name:'B.F. Goodstitch',city:'Salem',state:'MA',url:'https://www.bfgoodstitch.net',hours:'',phone:'',ig:''},
    {name:'Wellesley Needlepoint Collection',city:'Wellesley',state:'MA',url:'https://www.wellesleyneedlepoint.com',hours:'Tues-Sat 10am-3pm',phone:'781-721-1929',ig:'',lat:42.297,lng:-71.292},
    {name:'B\'s Stitches Fine Needlecrafts',city:'St. Michaels',state:'MD',url:'https://www.b-stitches.com',hours:'',phone:'',ig:''},
    {name:'Hillside Needlepoint',city:'Stevenson',state:'MD',url:'https://www.hillsideneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Stitchery Square',city:'Camden',state:'ME',url:'https://www.stitcherysquare.com',hours:'',phone:'',ig:''},
    {name:'Grace Robinson and Company',city:'Freeport',state:'ME',url:'https://www.yarnandneedlepoint.com',hours:'Tuesday - Saturday: 10AM - 3:30PM Sunday and Monday: Closed',phone:'',ig:''},
    {name:'Peacock Alley Needlepoint',city:'Ada',state:'MI',url:'https://www.peacockalleyneedlepoint.com',hours:'Mon-Fri  10am-4:30pm, Sat 12pm-3pm',phone:'',ig:''},
    {name:'The Needleworks (Birmingham)',city:'Birmingham',state:'MI',url:'https://www.eneedleworks.com',hours:'',phone:'',ig:''},
    {name:'Homestead Needle Arts',city:'Grand Blanc',state:'MI',url:'https://www.homesteadneedlearts.com',hours:'Wednesday, Friday, Saturday 10-4.  Closed Sundays, Mondays and Thursdays.  If the weather is bad, ple',phone:'',ig:''},
    {name:'The Wool & The Floss',city:'Grosse Pointe',state:'MI',url:'https://www.thewoolandthefloss.com',hours:'',phone:'',ig:''},
    {name:'Knotted Needle',city:'Grosse Pointe Woods',state:'MI',url:'https://www.knottedneedle.com',hours:'ointments available Monday Closed Tuesday to Saturday 11:30 am - 4 pm Sunday Closed Contact U',phone:'',ig:''},
    {name:'Crafty Lady Trio',city:'Macomb',state:'MI',url:'https://www.craftyladytrio.com',hours:'',phone:'',ig:''},
    {name:'The Picket Fence',city:'Edina',state:'MN',url:'https://www.thepicketfenceinc.com',hours:'',phone:'',ig:''},
    {name:'3 Kittens Needle Arts',city:'Mendota Heights',state:'MN',url:'https://www.3kittensneedlearts.com',hours:'Tues-Sat 10am - 3pm',phone:'(651) 457-4969',ig:'https://www.instagram.com/3kittensneedlearts/'},
    {name:'Needlework Unlimited',city:'Minneapolis',state:'MN',url:'https://www.needleworkunlimited.com',hours:'',phone:'',ig:''},
    {name:'Stitchville USA',city:'Minnetonka',state:'MN',url:'https://www.stitchville.com',hours:'',phone:'',ig:''},
    {name:'KC Needlepoint',city:'Kansas City',state:'MO',url:'https://www.kcneedlepoint.com',hours:'Boots Crests Custom Monogram Pillow Florals Food For The Bar Herend Inspired Canvases with Monograms Pillows Pineapples Rugs Signs & Sayings Square Self Finishing Inserts Topiaries Western Other Holidays Back to School Cinco de Mayo Easter Father\'s Day Halloween Mardi Gras New Year Patriotic Thanksgiving Valentine\'s Day Wedding/Engagement St Patrick\'s Day Spiritual Judaica Religious Baby/Juvenile Baby Mini Socks Baby Ornament Canvases Baby Sleeping Signs SORORITIES/FRATERNITIES Greek Round Canvases Greek Round Key Fobs Greek Travel Tags SPORTS Boating Football Golf Swimming Soccer Tennis Canvases by Artist + Artists A-C A Stitch In Time Abigail Cecile Alexa Alice & Blue Alice Peterson Needlepoint Allison Ivy Designs Ampersand Ann Kaye Studio Anne Fisher Associated Talents Audrey Wu August Morgan Bam Let\'s Mahjong! Barbara Pixton Bauble Stockings Birds of a Feather Blue Ridge Stitchery Burnett & Bradley CBK Designs Charlie Harper Coco Frank Studio Colors of Praise Cooper Oaks Designs Artists D-L Danji Designs Dogwood Needlepoint Doolittle Stitchery ELF Needlepoint Elizabeth Crane Swartz Emily Peacock Fire and Iris Designs Giddy Paperie goodpoint Hedgehog Needlepoint Heidi Stanley Designs Heirloom Textile Co. Hello Tess Designs Hook & Harbor Co. Initial K Studio J. Child Designs Jennifer Hall Jessica Lehane Kangaroo Paws Kathy Schenkel KCN Designers Kirk & Bradley Lauralove Designs Lauren Bloch Designs Le Point Studio Lee\'s Needle Arts Lemon Daisy Liesel Anne Studios Lo Harris Lovevolve love mhb studio Artists M-R MA Designs Melissa Shirley MM Designs Mrs. Blandings Moo Moo Designs Mopsey Designs Morgan Julia Designs Needle Crossings Pearly Gates Penny Linn Designs Pepperberry Designs Poppy\'s Designs Presley Goode Princess & Me Rachel Barri Rachel Donley Rebecca Wood Artists S-Z Sailor Stitches Saturnalia Stitching SCT Designs Silver Needle Silver Stitch Needlepoint SLS Needlepoint Spellbound Stitchery Spruce St. Studio Stitch-Its Stitch Rock Designs Stitch Style Susan Cowden Susan Roberts Taylor Beach The Gingham Stitchery The Makers Marks The Meredith Collection The Plum Stitchery Thorn Alexander Tina Griffin Designs What\'s the Stitch Wipstitch Needleworks Ziggy Stitches Fibers + Fibers A-E Accentuate Alpaca Angora Appleton Crewel Wool Appleton Tapestry Wool Arctic Rays Bella Lusso Wool Bisous Bouclé Capri Crystal Braid DMC 3 Pearl Cotton DMC 5 Pearl Cotton Entice Essentials 10yd Card Essentials 30yd Skein Eyelash Fibers F-O Flair Frosty Rays Fluffy Fleece Fuzzy Stuff Fyre Werks Fyre Werks Soft Sheen Glisten Gold Rush Grandeur Kreinik Mandarin Floss Milan Skeins Milan Cards Neon Rays Neon Rays+ Fibers P-R Painter\'s Shimmer Panache Pepper Pot Silk 30yd Skein Pepper Pot Silk 10yd Card Petite Frosty Rays Petite Silk Lame Braid Petite Sparkle Rays Petite Very Velvet Planet Earth 6 Ply Variegated Planet Earth Silk Planet Earth Wool Radiance for 13 mesh Radiance for 18 mesh Rainbow Linen Reflections Fibers S-Z Silk & Ivory Silk Lamé Braid for 13 Mesh Silk Lame Braid for 18 Mesh Silk Ribbon 4mm Silk Ribbon 7mm Soie Tissée Sparkle Rays Splendor Stardust ThreadworX Cotton Floss ThreadworX Overdyed Legacy ThreadworX Overdyed Metallic Very Velvet Vineyard Merino Wool Vineyard Silk Cards Vineyard Silk Skeins Water n\' Ice Watercolours Wisper Winter Accessories & More + Bags Beading Supplies Books Finished Products Gift Cards Laying Tools Leather Goods Lights Needles Needle Minders Needle Threaders Paper Goods Self Finishing Accessories Scissors Stretcher Bars Clothing Learn + BLOG FIBER FACTS BACK TO BASICS Continental Stitch Basketweave Stitch Needlepoint Stretcher Bar Assembly Putting Needlepoint Canvas on Stretcher Bars CLASSES THE STITCH VAULT Gift Cards SALE Load slide 1 of 3 Load slide 2 of 3 Load slide 3 of 3 Previous Next Previous New needlepoint canvases! Next View all Trust Angel Canvas $ 65.00 Forgive Angel Canvas $ 65.00 Grace Angel Canvas $ 65.00 Chickadee Patriotic House Canvas $ 95.00 Apple Pie Canvas $ 75.00 Winter Cardinals Canvas $ 178.00 Monarch Butterfly Canvas $ 50.00 Lemon Canvas $ 50.00 Beach Bound Canvas $ 50.00 Out of Stock Candy Corn Stamp Canvas $ 45.00 Out of Stock I\'ll Be Gnome for Christmas Canvas $ 105.00 Jumping Bunnies Canvas $ 105.00 Out of Stock Beach Round Canvas $ 69.00 Out of Stock Out of Stock La Dolce Vita Lemons Canvas $ 75.00 Out of Stock Out of Stock Shark Tooth Round Canvas $ 75.00 Out of Stock Shiny Brites Box Canvas $ 62.00 Trick or Treat Canvas $ 85.00 Put It On My Tab Canvas $ 60.00 Tennis Whites Canvas $ 60.00 Two Zebras Canvas $ 85.00 Previous Get all the help you need on your next needlepoint project. Shop kits! Next View all Our Initial Thought - Bag/Luggage Tag Kit (Rosy Cheeks) $ 95.00 Out of Stock Beach Bliss Bag/Luggage Tag Kit $ 95.00 Out of Stock Out of Stock Ski Scene Bag/Luggage Tag Kit $ 95.00 Out of Stock Out of Stock Tropical Serenity Bag Tag/Key Fob Kit $ 70.00 Out of Stock Out of Stock Plaid Circle Bag Tag/Fob Kit $ 70.00 Out of Stock On The Surf Coaster Kit $ 95.00 Out of Stock Bamboo Eyeglass Case Kit $ 95.00 Out of Stock Out of Stock Trio of Seashells Eyeglass Case Kit $ 95.00 Out of Stock Out of Stock Peace Out Bag Tag/Key Fob Kit $ 70.00 Out of Stock Out of Stock Cocktail Celebration Eyeglass Case Kit $ 95.00 Out of Stock Out of Stock Moon Face Bag Tag/Key Fob Kit $ 70.00 Out of Stock Out of Stock Moody Mountains Coaster Kit $ 95.00 Out of Stock Out of Stock Lovevolve Bag/Luggage Tag Kit $ 95.00 Out of Stock Bloom and Express Bag/Luggage Tag Kit $ 95.00 CIAO Bag/Luggage Tag Kit $ 95.00 Out of Stock Oh, Heavens! Kit $ 70.00 Out of Stock The Mahj Bag Tag/Key Fob Kit $ 70.00 Out of Stock Home Sweet Home Kit $ 70.00 Out of Stock Zebra Dot Bag Tag/Key Fob Kit $ 70.00 On the Surf Bag/Luggage Tag Kit $ 95.00 Get exclusive access to needlepoint products and sales! Do you want access to discounts and exclusive products? Sign up to receive text messages from KC Needlepoint! Click to sign up! About KC Needlepoint KC Needlepoint is your one stop needlepoint shop for all of your stitching needs! Whether you are a seasoned stitcher or are looking for your very first needlepoint project, you will be able to find something you love at KC Needlepoint. If you\'re looking to take the guesswork out of your next project, purchase one of our premade needlepoint kits, available in a variety of different skill levels. Alternatively, peruse through different canvas themes and choose from over 10,000 different designs available online. When you have picked out your canvas, we are ready to help you select threads from a variety of wools, silks, cottons and other specialty fibers to make your project truly one of a kind! When you have finished stitching your needlepoint project, contact us to discuss the wide range of finishing options we have to offer. No matter where you live, KC Needlepoint offers free USPS shipping on every order shipped within the United States. If you are local to the Kansas City area, swing by and visit us in our retail shop at 8050 Wornall Road.  We can\'t wait to help you find your next needlepoint project! Visit us at our retail needlepoint shop! We\'d love to meet you in person! 8050 Wornall Road, Kansas City, MO 64114 Shop hours: Tuesday-Friday 10:00am-4:00pm Saturday 10:00am-3:00pm Gift Card Our Location Conta',phone:'',ig:'',lat:39.099,lng:-94.578},
    {name:'Sign of the Arrow',city:'St. Louis',state:'MO',url:'https://www.signofthearrow.com',hours:'',phone:'',ig:''},
    {name:'The First & Last Stitch',city:'St. Louis',state:'MO',url:'https://www.firstandlast.com',hours:'Your personal information Close Fill-in your basic information to submit the offer for firstandlast.com First name * Required field Last name * Required field Email * Email address is not valid Phone Number * 000 Select country Close After entering your personal info you will be redirected to spaceship.com where you can negotiate the purchase of this domain. Submit offer',phone:'',ig:'',lat:38.627,lng:-90.197},
    {name:'The Needlepoint Clubhouse',city:'St. Louis',state:'MO',url:'https://www.stlneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'The French Knot (Diamondhead)',city:'Diamondhead',state:'MS',url:'https://www.frknot.com',hours:'',phone:'',ig:''},
    {name:'Natchez Needle Arts',city:'Natchez',state:'MS',url:'https://www.natchezneedlearts.com',hours:'',phone:'',ig:''},
    {name:'Chapel Hill Needlepoint',city:'Chapel Hill',state:'NC',url:'https://chapelhillneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Po\'s Point',city:'Charlotte',state:'NC',url:'https://posneedlepoint.com',hours:'Tues- Sat 11am - 4pm',phone:'704-553-8777',ig:''},
    {name:'The Needlecraft Center',city:'Davidson',state:'NC',url:'https://www.needlecraftcenter.com',hours:'',phone:'',ig:''},
    {name:'Stitching Chicks Needlepoint',city:'Hendersonville',state:'NC',url:'https://stitchingchicksneedlepoint.com',hours:'Store Location',phone:'',ig:''},
    {name:'Personal Threads Boutique',city:'Omaha',state:'NE',url:'https://www.personalthreads.com',hours:'Mon-Fri 9am-6pm, Sat 9am-3pm Sunday: closed',phone:'(402)391-7733',ig:'',lat:41.257,lng:-95.995},
    {name:'Village Needleworks (Omaha)',city:'Omaha',state:'NE',url:'https://www.villageneedleworks.com',hours:'Tues-Sat 10am-3pm',phone:'(402) 391-1191',ig:'',lat:41.257,lng:-95.995},
    {name:'Bay Head Needlepoint',city:'Bay Head',state:'NJ',url:'https://www.bayheadneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Gone Stitching',city:'Bergenfield',state:'NJ',url:'https://www.gonestitching.net',hours:'Email Newsletter Name Email * Phone number Comment Send',phone:'',ig:''},
    {name:'Beyond Knits & Needles',city:'Caldwell',state:'NJ',url:'https://www.beyondknitsandneedles.net',hours:'',phone:'',ig:''},
    {name:'Stitching Pretty',city:'Eatontown',state:'NJ',url:'https://stitching-pretty.squarespace.com',hours:'7724 (732) 996-7376 Sunday 10:00 am - 2:00 pm Monday - Tuesday 10:00 am - 4:00 pm Wednesday 12:',phone:'',ig:''},
    {name:'Threads Too Needlepoint',city:'Fair Haven',state:'NJ',url:'https://www.threads-too.com',hours:'',phone:'',ig:''},
    {name:'Nimble Needle (Haddonfield)',city:'Haddonfield',state:'NJ',url:'https://www.nimbleneedle.net',hours:'',phone:'',ig:''},
    {name:'Morgan Julia Designs (Jersey City)',city:'Jersey City',state:'NJ',url:'https://morganjuliadesigns.com',hours:'',phone:'',ig:''},
    {name:'Nimble Needle (Merchantville)',city:'Merchantville',state:'NJ',url:'https://www.nimbleneedlenj.com',hours:'Shop •Tues through Friday 12:00- 5:00 Saturdays 11:00-4:00 Mornings by Appointment Christmas Hours: Open Dec23 11:00-4:00 Closed Dec24-Jan1 •Email orders are welcome! sales@thenimbleneedle',phone:'',ig:''},
    {name:'Needleworker\'s Delight',city:'Metuchen',state:'NJ',url:'https://www.needleworkersdelight.com',hours:'',phone:'',ig:''},
    {name:'Scrim Discovery Needlepoint',city:'Ocean City',state:'NJ',url:'https://www.scrimdiscovery.com',hours:'Jersey,
is just an hour from Philadelphia 
and 20 minutes north of Cape May. If you\'re in the 
area, w',phone:'',ig:''},
    {name:'Knit One Stitch Too',city:'Pennington',state:'NJ',url:'https://www.k1st2.com',hours:'VISIT 16 N. Main St. Pennington, NJ. 08534 Get Directions HOURS Monday – Saturday 11:00AM to 5:00PM. Sunday 12-4pm. Closed major holidays and sundays in summer. CONTACT Main: (609) 737-2211 knitonestitchtoo@gmail.com Facebook Tiktok Instagram',phone:'',ig:''},
    {name:'Ridgewood Needlepoint',city:'Wyckoff',state:'NJ',url:'https://www.ridgewoodneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Ladybug Stitches',city:'Bohemia',state:'NY',url:'https://www.ladybugstitches.com',hours:'',phone:'',ig:''},
    {name:'Expressions in Needleart',city:'Canandaigua',state:'NY',url:'https://www.expressionsinneedleart.com',hours:'Enter using password',phone:'',ig:''},
    {name:'Stitch by Stitch',city:'Larchmont',state:'NY',url:'https://www.stitchbystitchneedlepoint.com',hours:'Tues-Fri 10AM-4PM',phone:'914-834-1886',ig:''},
    {name:'The Red Thread Atelier',city:'Locust Valley',state:'NY',url:'https://www.theredthreadatelier.com',hours:'',phone:'',ig:'',lat:40.876,lng:-73.594},
    {name:'The Needlepaint Nook',city:'Merrick',state:'NY',url:'https://www.theneedlepaintnook.com',hours:'il protected] Store Hours: Wednesday 10:30 – 5:00 Thursday 12:30 – 6:00 Friday 10:30 – 5:00 Saturday 10:30 – 2:30 Follow Follow Copyright © 2024 Needlepaint Nook | Cre',phone:'',ig:''},
    {name:'Keep Me in Needlepoint',city:'Nesconset',state:'NY',url:'https://www.keepmeinneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Annie & Company',city:'New York',state:'NY',url:'https://www.annieandco.com',hours:'Mon-Fri 10am-6pm, Sat 11am-5:pm, Sun 12pm-5pm',phone:'212) 360-7266 or (212) 289-2944',ig:'https://instagram.com/annieandco.nyc',lat:40.713,lng:-74.006},
    {name:'Rita\'s Needlepoint',city:'New York',state:'NY',url:'https://www.ritasneedlepoint.com',hours:'10:30 am - 6:00 pm Thursday: 10:30 am - 6:00 pm Friday: 10:30 am - 6:00 pm Saturday: 10:30 am - 5',phone:'',ig:''},
    {name:'West Village Knit & Needle',city:'New York',state:'NY',url:'https://www.wvknitandneedle.com',hours:'',phone:'',ig:''},
    {name:'Bargello Needlepoint',city:'Tuckahoe',state:'NY',url:'https://www.bargello-needlepoint.com',hours:'Tues, Thurs, Fri 10–4pm, Wed 2pm-7:30pm, Sat 10–2pm',phone:'914-361-1014',ig:'https://instagram.com/bargelloneedlepointny'},
    {name:'Needlepoint Gallery & More',city:'Woodridge',state:'NY',url:'https://www.theneedlepointgallery.com',hours:'e shipped within 96-hours of order unless there is a holiday which will delay the shipping. CANADA SHIPPING: We ship USPS Standard to Canada If an item is out of stoc',phone:'',ig:''},
    {name:'I of the Needle',city:'Akron',state:'OH',url:'https://www.ioftheneedleakron.com',hours:'dleakron.com Hours: Tuesday-Saturday 10-4 Social Media Email Facebook Instagram Copyright © 2026 i of the needle . Powered by Shopify Cookies This website uses cookies to ensure you get the best experience on your device. Accept all cookies Decline all cookies cookies-popups-0 Pickup location i of the needle Free .
                Usually ready in 24 hrs Store Hours Sun: Closed Mon-Fri: 9:00 - 17:00 Sat: 10:00 - 13:00 What to expect at',phone:'',ig:''},
    {name:'Absolutely Needlepoint (Cincinnati)',city:'Cincinnati',state:'OH',url:'https://www.absolutelyneedlepointcincy.com',hours:'Mon-Fri 10am-5pm, Sat 10am-3pm',phone:'513-561-7999',ig:'https://www.instagram.com/4583895108/',lat:39.103,lng:-84.512},
    {name:'The Top Drawer',city:'Cincinnati',state:'OH',url:'https://www.topdrawer-needlepoint.com',hours:'',phone:'',ig:''},
    {name:'Wool & Willow Needlepoint',city:'Cleveland Heights',state:'OH',url:'https://www.woolandwillow.com',hours:'Tues–Fri 11am–5pm Sat 11am–4pm',phone:'216-791-7952',ig:'https://www.instagram.com/woolandwillowneedlepoint'},
    {name:'Park Avenue Needlepoint',city:'Dayton',state:'OH',url:'https://www.parkavenueneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'What\'s the Point',city:'Dublin',state:'OH',url:'https://www.whatsthepoint.biz',hours:'Mon-Sat 10am-4pm, Thurs 10am-7:30pm',phone:'(614) 717-9008',ig:'https://www.instagram.com/whatsthepoint.needlepoint/'},
    {name:'Louise\'s Needlework',city:'Powell',state:'OH',url:'https://www.louisesneedlework.com',hours:'',phone:'',ig:''},
    {name:'In Stitches (Portland)',city:'Portland',state:'OR',url:'https://www.institchespdx.com',hours:'',phone:'',ig:''},
    {name:'The Playful Needle',city:'Portland',state:'OR',url:'https://www.the-playful-needle.com',hours:'',phone:'',ig:''},
    {name:'Fireside Stitchery',city:'Malvern',state:'PA',url:'https://www.firesidestitchery.com',hours:'ches, refreshments, Friday welcome dinner, exclusive shopping and discounts, and access to amazing on-site classes! Breakout Class opportunities include Decorative Stitch Class with Cynthia Thomas, Monogramming Class with Anne Fisher & Finishing Class with Fireside. Sign up below! Sign up Ready to ship in stock needlepoint canvases shop Hosting monthly trunk shows Trunk shows 20% off this month\'s featured designers Shop Mountain Laurel - PA State Flower Spellbound Stitchery Exclusive Fireside Stitching Anne Fisher exclusive Stand tray attachment Exclusive - Made in-House Love Letter from Philly Blue Canary Exclusive Sports 3" Round SA Exclusive Fly Bird SA Exclusive Wooden Laying Tool Case Exclusive - Made in-House Birdhouse - Wooden Needle Case Exclusive - Made in-House Fireside Flame Logo Fireside Exclusive Home to various complete thread lines Kit your masterpiece Over 100 complete thread lines in store and online to keep threads at your fingertips, where they belong shop Did you know that Fireside offers an ebay storefront? $0.99 starting bids ebay LONG-TIME, REPEAT BUYER. PROFESSIONAL, 5-STAR SELLER. HIGHLY RECOMMEND -ebay customer Top-rated reseller offering threads, canvases & more Sell with Fireside Custom Orders Can\'t find what you\'re looking for? We can order painted canvases from designers we do not have listed on our site, out of stock threads, or just about anything else you can think of. If you\'d like to place a custom order, visit our contact page and fill out the custom order form. Leather soft clutch with zipper and internal pocket Box lumbar pillow Tree topper Alice Peterson Canvas, Fireside Stitchery Stitch Guide Liz Goodrick-Dillon Canvas, Fireside Stitchery Stitch Guide Previous Next About our store Fireside Stitchery is a full service needlepoint shop. We provide a wide range of canvases, notions, and fibers for your needlework. Location 179 Lancaster Avenue, Suite 3 Malvern, PA 19355 610-889-9835 Just a 5 minute Uber from Malvern Septa station! Hours Tuesday - Friday 10am-4pm Saturday 10am-3pm Sunday & Monday Closed Main menu Thre',phone:'',ig:'',lat:40.036,lng:-75.513},
    {name:'Gazebo Plus',city:'New Hope',state:'PA',url:'https://www.gazeboplus.com',hours:'',phone:'',ig:''},
    {name:'Rittenhouse Needlepoint',city:'Philadelphia',state:'PA',url:'https://www.rittenhouseneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Needle Point Breeze',city:'Pittsburgh',state:'PA',url:'https://www.needlepointbreeze.com',hours:'',phone:'',ig:''},
    {name:'The Beehive Needlearts',city:'Pittsburgh',state:'PA',url:'https://www.beehiveneedlearts.com',hours:'Enter your email Subscribe icon-email Subscribe',phone:'',ig:'',lat:40.44,lng:-79.996},
    {name:'Porcupine Needlepoint Shop',city:'Sewickley',state:'PA',url:'https://www.theporcupineneedlepointshop.com',hours:'',phone:'',ig:''},
    {name:'Stitch Haus',city:'Wayne',state:'PA',url:'https://www.stitchhaus.com',hours:'Mon-Thurs 10am-5pm, Fri-Sat 10am-4pm',phone:'',ig:'',lat:40.043,lng:-75.387},
    {name:'The Picket Fence (Barrington)',city:'Barrington',state:'RI',url:'https://picketfenceneedlepoint.com',hours:'',phone:'(401) 245-0484',ig:''},
    {name:'Needlepoint by the Bay',city:'East Greenwich',state:'RI',url:'https://needlepointbythebay.com',hours:'Visit our shop Address 5853 Post Rd Suite 102A, 
East Greenwich, RI 02818 Get directions Open hours Wednesday - 10:00 AM — 4:00 PM Thursday - 10:00 AM - 8:00 PM Friday  and Saturday 10:00 AM — 4:00 PM Sunday 11:00 AM - 3:00 PM Mon - Tuesday Closed Contact info +1-401-471-7614 wendy@needlepointbythebay.com',phone:'',ig:''},
    {name:'Lycette Designs (Newport)',city:'Newport',state:'RI',url:'https://www.lycettedesigns.com',hours:'Name Email Message',phone:'',ig:'',lat:41.49,lng:-71.312},
    {name:'Cabbage Row Shoppe',city:'Charleston',state:'SC',url:'https://www.cabbagerow.com',hours:'',phone:'',ig:''},
    {name:'The Needle Tree',city:'Greenville',state:'SC',url:'https://www.theneedletree.com',hours:'Your source for the finest yarns, hand painted canvases and accessories.',phone:'',ig:'',lat:34.852,lng:-82.394},
    {name:'Needlepoint Junction (Hilton Head)',city:'Hilton Head Island',state:'SC',url:'https://shopneedlepointjunction.com',hours:'Logout Let’s Chat! Monday - Friday: 9:30 - 4:00 Saturday: 9:30 - 2:00 Sunday: Closed 1000 William Hilton Parkway Ste J7E Hilton Head Island, SC',phone:'',ig:'',lat:32.216,lng:-80.752},
    {name:'It\'s a Stitch (Johns Island)',city:'Johns Island',state:'SC',url:'https://www.itsastitch.net',hours:'',phone:'',ig:''},
    {name:'Stitching Fox',city:'Landrum',state:'SC',url:'https://www.stitchingfox.com',hours:'Email address Sign up',phone:'',ig:''},
    {name:'A. Bradley Needlearts',city:'Myrtle Beach',state:'SC',url:'https://www.abradleyneedlearts.com',hours:'',phone:'',ig:''},
    {name:'Pawleys Island Needlepoint',city:'Pawleys Island',state:'SC',url:'https://www.pineedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Two\'s Company Needlepoint',city:'Rock Hill',state:'SC',url:'https://www.twoscompanyneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Barbara\'s Needlepoint',city:'Sioux Falls',state:'SD',url:'https://www.barbarasneedlepoint.com',hours:'Mon-Fri 10am-4pm, Sat 10am-3pm',phone:'605-367-9050',ig:'https://www.instagram.com/barbarasneedlepoint'},
    {name:'Nashville Needleworks',city:'Brentwood',state:'TN',url:'https://www.nashvilleneedleworks.com',hours:'ers over $200! Shop Hours: Mon thru Sat 10 a.m. to 4 p.m. Open Online 7x24. Item added to your cart View cart Check out Continue shopping Browse the most recent additi',phone:'',ig:''},
    {name:'Amy\'s Golden Strand',city:'Memphis',state:'TN',url:'https://www.amybunger.com',hours:'',phone:'',ig:''},
    {name:'Stitchers, Inc.',city:'Memphis',state:'TN',url:'https://www.stitchersinc.com',hours:'',phone:'',ig:''},
    {name:'Needleworks of Austin (The Needle Works)',city:'Austin',state:'TX',url:'https://theneedleworks.com',hours:'W, F: 10 am – 4 pm, Thurs: 10am – 7pm, Sat. 10 am – 3 pm A year-long creative lab exploring',phone:'',ig:'',lat:30.267,lng:-97.743},
    {name:'Fancy Stitches',city:'Cleburne',state:'TX',url:'https://www.fancystitches.com',hours:'76033 Store Hours: Wednesday , Thursday, Friday & Saturday 11:00 to 4:00 Closed Sunday, Monday , & Tuesday Here\'s What You Will Find Here\'s',phone:'',ig:''},
    {name:'Creative Stitches & Gifts',city:'Dallas',state:'TX',url:'https://www.creativestitchesandgifts.com',hours:'Tues-Fri 10am-4pm, Sat 10am-2pm',phone:'(214) 361 2610',ig:'https://www.instagram.com/creativestitchesandgifts',lat:32.776,lng:-96.797},
    {name:'Needlepoint This!',city:'Dallas',state:'TX',url:'https://www.needlepointthis.com',hours:'',phone:'',ig:''},
    {name:'Wipstitch Needleworks',city:'Dallas',state:'TX',url:'https://wipstitch.com',hours:'Wed-Sat 12-4pm',phone:'(214) 909-8538',ig:'https://www.instagram.com/wipstitchneedleworks/?hl=en',lat:32.776,lng:-96.797},
    {name:'The French Knott',city:'Fort Worth',state:'TX',url:'https://www.thefrenchknot.com',hours:'Mon-Sat 10am-5pm',phone:'817-731-3446',ig:'',lat:32.755,lng:-97.33},
    {name:'Judy\'s Stitchery Nook',city:'Harlingen',state:'TX',url:'https://www.judystitcherynook.com',hours:'',phone:'',ig:''},
    {name:'Blue Bonnet Studio',city:'Houston',state:'TX',url:'https://www.bluebonnetstudio.com',hours:'',phone:'',ig:''},
    {name:'Chandail Needlework',city:'Houston',state:'TX',url:'https://www.chandailneedlework.com',hours:'Fri 10am-5pm, Thurs & Sat 10am-4pm',phone:'(713) 524-6942',ig:'https://m.facebook.com/Chandail-Needlework-140088702721572/',lat:29.76,lng:-95.369},
    {name:'Chaparral Needlework',city:'Houston',state:'TX',url:'https://www.ndlpt.com',hours:'',phone:'',ig:''},
    {name:'Nimblefingers',city:'Houston',state:'TX',url:'https://www.nimblefingerstx.com',hours:'',phone:'',ig:'',lat:29.76,lng:-95.369},
    {name:'Stitches in Time (Houston)',city:'Houston',state:'TX',url:'https://www.stitchesintimeneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'The Needle House',city:'Houston',state:'TX',url:'https://www.theneedlehouse.com',hours:'',phone:'',ig:''},
    {name:'Pocket Full of Stitches',city:'Lubbock',state:'TX',url:'https://www.pfos.com',hours:'Tues - Fri, 10am - 5pm, Saturday 10am-4pm',phone:'806-792-1761',ig:'',lat:33.578,lng:-101.855},
    {name:'Snippets Texas',city:'New Braunfels',state:'TX',url:'https://www.snippetstexas.com',hours:'',phone:'',ig:''},
    {name:'Chandler Cottage Needlepoint',city:'San Angelo',state:'TX',url:'https://www.chandlercottage.com',hours:'',phone:'',ig:''},
    {name:'Clark & Company',city:'San Antonio',state:'TX',url:'https://www.clarkneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Stitch Therapy Needlepoint (Spring)',city:'Spring',state:'TX',url:'https://www.stitchtherapyneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'Storyteller\'s Thread',city:'Spring',state:'TX',url:'https://storytellersthread.com',hours:'Pickup available at Storyteller’s Thread',phone:'',ig:''},
    {name:'Past Times Needlepoint',city:'Victoria',state:'TX',url:'https://www.pasttimesneedlepoint.com',hours:'',phone:'',ig:''},
    {name:'In Stitches Needlework (Alexandria)',city:'Alexandria',state:'VA',url:'https://www.institchesneedlework.com',hours:'es100@aol.com Hours Monday through Saturday 10am - 3pm NOTE: We no longer carry knitting supplies Connect wi',phone:'',ig:'',lat:38.804,lng:-77.047},
    {name:'Waste Knot Needlepoint',city:'Arlington',state:'VA',url:'https://www.wasteknotneedlepoint.com',hours:'Mon-Sat 10am-4pm',phone:'(703) 807-1828',ig:'https://www.instagram.com/waste_knot_needlepoint/',lat:38.88,lng:-77.101},
    {name:'Caroline\'s Thread & Canvas',city:'Ashland',state:'VA',url:'https://www.carolinesthreadandcanvas.com',hours:'',phone:'',ig:''},
    {name:'Magpie Knits (Threads)',city:'Charlottesville',state:'VA',url:'https://www.magpieknits.com',hours:'434-296-4625 [email protected]',phone:'',ig:'',lat:38.029,lng:-78.477},
    {name:'poppypointe',city:'Charlottesville',state:'VA',url:'https://poppypointe.com',hours:'Wed 11am-7pm, Thurs-Fri 11am-4pm, Sat 10am-2pm',phone:'434-422-8174',ig:'',lat:38.029,lng:-78.477},
    {name:'The Needle Lady',city:'Charlottesville',state:'VA',url:'https://www.needlelady.com',hours:'',phone:'',ig:''},
    {name:'Needles in the Haymarket',city:'Haymarket',state:'VA',url:'https://www.needlesinthehaymarket.com',hours:'inesville, VA 20155 Monday - Saturday 10:00 a.m. - 5:00 p.m. Closed Sundays Directions Quick links Search Return Policy Shippin',phone:'',ig:''},
    {name:'Stitch Middleburg',city:'Middleburg',state:'VA',url:'https://www.stitchmiddleburg.com',hours:'',phone:'',ig:''},
    {name:'Jermie\'s Needlepoint & Linens',city:'Richmond',state:'VA',url:'https://www.jermiestoo.com',hours:'',phone:'',ig:''},
    {name:'The Stitching Studio',city:'Richmond',state:'VA',url:'https://www.thestitchingstudiova.com',hours:'Tues-Fri 10am-5pm, Sat 10am-4pm',phone:'',ig:'',lat:37.541,lng:-77.434},
    {name:'West End Needlepoint',city:'Richmond',state:'VA',url:'https://www.westendneedlepoint.com',hours:'Tues, Thurs, Fri 10am-4pm, Weds 10am-7:30pm Sat 10am-3pm',phone:'804-562-4285',ig:'',lat:37.541,lng:-77.434},
    {name:'In Stitches Fine Needlepoint',city:'Dorset',state:'VT',url:'https://www.institchesfineneedlepoint.com',hours:'oute 30, Dorset, Vermont Mailing Address:
PO Box 452 Dorset, Vermont 05251 (802) 867-7031 Email: institchesvt@gmail.com Shop Hours Today Closed Drop us a line! Drop us a line! Name Email* This site is pr',phone:'',ig:''},
    {name:'Rain City Needlepoint',city:'Bellevue',state:'WA',url:'https://raincityneedlepoint.com',hours:'',phone:'',ig:'',lat:47.61,lng:-122.201},
    {name:'The Needlepointer',city:'Everett',state:'WA',url:'https://www.theneedlepointer.com',hours:'ip within about one month. Shop now Explore our abundant threads Immerse yourself in a world of endless color and texture. From silky cottons to rich wools, each thread is thoughtfully crafted to inspire creativity and elevate every stitch. Add Threads Stitch-to-finish Stitch-to-Finish is our signature innovation that combines stitching and finishing in one seamless experience. Each kit includes coordinated materials, guided instructions, and our patent-pending self-finishing system, allowing you to create a beautifully finished piece from the first stitch to the final detail—no professional finishing required. Shop now ACCESSORIES Essential tools for effortless needlepoint — laying tools, stretcher bars, needles, nails, and scissors designed for precision, ease, and finesse. Shop now Customer Support Customer Support Contact Us Reward Program Shipping & Order Policy Programs & Service Programs & Service Monthly Trunk Show Finishing Service Subscription Box Our Newsletter - Get Updates, Offers and Invites. Email Showroom: 1944 Terracina Dr., Sacramento, CA 95834 Hours: 10am - 4pm Mon-Fri Stay Connected © 2026 The Needlepointer Priva',phone:'',ig:''},
    {name:'Threadneedle Street',city:'Issaquah',state:'WA',url:'https://www.threadneedlestreet.com',hours:'',phone:'',ig:''},
    {name:'The Blue Peony',city:'Langley',state:'WA',url:'https://thebluepeony.com',hours:'Hours Mon: 11-4ish Tue / Wed: Out Creating Thurs /Fri / Sat: 11-4ish Sun: Closed Delivery icon Free shipping When you spend $60+ Envelope ic',phone:'',ig:''},
    {name:'Heirloom Designs Studio',city:'Seattle',state:'WA',url:'https://heirloomdesigns.studio',hours:'e WA 98122. Regular hours are W-Sat 11-5. Phone: 206-313-9838 **NOTE: We will open one hour late on Saturday 2/7 for a special event.** Item added to your cart View m',phone:'',ig:'',lat:47.606,lng:-122.332},
];
          ...
          {tab==='map'&&(
            <div className="fadein">
              <div className="sec-head">
                ...
                <div className="sec-sub">{SHOPS.length} verified shops — with hours, specialties, and class schedules. Hover a pin for a quick preview.</div>
              </div>
              <div className="mapsec">
                ...
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:14}}>
                  <span style={{fontSize:13,color:T.warmGray}}>{SHOPS.length} shops · <span style={{color:T.navy,cursor:'pointer'}}>Is your shop missing? Add it &#x2192;</span></span>
                  <input className="sinput" style={{maxWidth:260}} placeholder="Search by city or state…"/>
                </div>
